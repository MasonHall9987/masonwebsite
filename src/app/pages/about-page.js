        ...
        <div className="scrollbar-3d">
          <div className="mb-6 leading-[1.8]">
            ...
            <p>
              ...
              <span> </span>
              <a href={"https://pub-f3ed1098080a4128adc7fb10cb429333.r2.dev/images/mason-hall-resume.jpg"} target="_blank" rel="noopener noreferrer" className="underline-link hide-cursor-on-hover">here</a>.
            </p>
