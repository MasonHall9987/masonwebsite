...
const splashTextOptions = ['Who pushed to main?', 'Built with HTML and bedrock!', 'Now with 73 unused npm packages!', "git commit -m 'final FINAL version'", 
  ...
  "Definitely not written in production", "Smells like merge conflict spirit", "Please don't inspect the element", "Documented in ancient runes", "Insert Stack Overflow solution here", "Proffesional developer Vibe Coder"];
